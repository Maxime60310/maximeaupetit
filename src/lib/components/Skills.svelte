<!-- Devicon CSS pour les icônes colorées -->
<svelte:head>
	<link
		rel="stylesheet"
...
<section id="skills" class="section-skills">
	<div class="container">
		...
		<p class="section-subtitle">Technologies que je maîtrise et utilise au quotidien</p>
		...
		<div class="skills-content">
			...
			<div class="skill-category">
				<h3 class="category-title">Frameworks CSS</h3>
				<div class="skills-grid">
					<div class="skill-item">
			...
			<div class="skill-category">
				<h3 class="category-title">Frameworks JavaScript</h3>
				<div class="skills-grid">
					<div class="skill-item">
						<i class="devicon-svelte-plain colored icon"></i>
						<span class="text">SvelteKit</span>
					</div>
					<div class="skill-item">
			...
			<div class="skill-category">
				...
				<div class="skills-grid">
					<div class="skill-item">
						<i class="devicon-php-plain colored icon"></i>
					...
					<div class="skill-item">
						<i class="devicon-symfony-plain icon symfony-light"></i>
			...
			<div class="skill-category">
				<h3 class="category-title">Outils & Plateformes</h3>
				<div class="skills-grid">
					<div class="skill-item">
						<i class="devicon-vscode-plain colored icon"></i>
						<span class="text">VSCode</span>
					</div>
					<div class="skill-item">
						<svg
							class="icon cursor-icon"
							viewBox="0 0 24 24"
							fill="none"
						...
						>
							...
							/><defs xmlns="http://www.w3.org/2000/svg"
								><linearGradient
									...
									y1="12"
									y2="24"
									><stop offset=".16" stop-color="#FFFFFF" stop-opacity=".8" /><stop
										offset=".658"
										stop-color="#E0E0E0"
										stop-opacity=".9"
									/></linearGradient
								><linearGradient
									...
									y1="6.037"
									y2="12.15"
									><stop offset=".182" stop-color="#FFFFFF" stop-opacity=".7" /><stop
										offset=".715"
										stop-color="#E0E0E0"
										stop-opacity=".5"
									/></linearGradient
								><linearGradient
									...
									y1="0"
									y2="18"
									><stop stop-color="#FFFFFF" stop-opacity=".9" /><stop
										offset=".667"
										stop-color="#E0E0E0"
										stop-opacity=".7"
									/></linearGradient
					...
					<div class="skill-item">
						<i class="devicon-github-original-wordmark icon github-light"></i>
			...
			<div class="skill-category">
				<h3 class="category-title">Compétences spécialisées</h3>
				<div class="skills-grid">
					<div class="skill-item">
						<svg
							class="icon api-icon"
							...
							xmlns="http://www.w3.org/2000/svg"
						>
							<path d="M14 12l-4 4V8l4 4z" fill="#00D2FF" />
							<path d="M20 12l-4 4V8l4 4z" fill="#00D2FF" />
							<path d="M8 12l-4 4V8l4 4z" fill="#00D2FF" />
						</svg>
						<span class="text">Systèmes API</span>
					</div>
					<div class="skill-item">
						<svg
							class="icon responsive-icon"
							viewBox="0 0 24 24"
							fill="none"
							xmlns="http://www.w3.org/2000/svg"
						>
							<rect x="2" y="4" width="20" height="12" rx="2" fill="#4CAF50" stroke="#4CAF50" />
							<rect x="6" y="18" width="12" height="2" rx="1" fill="#4CAF50" />
							<rect x="16" y="6" width="4" height="8" rx="1" fill="#81C784" />
						</svg>
					...
					<div class="skill-item">
						...
						<span class="text">Utilisation optimisée de l'IA</span>
					</div>
				</div>
			</div>
		</div>
...
<style>
	...
	.category-title {
		...
		text-align: center;
		border-bottom: 2px solid #284d3c;
	...
	/* Styles spécifiques pour les icônes SVG personnalisées */
	.skill-item .cursor-icon,
	.skill-item .postman-icon,
	.skill-item .figma-icon,
	.skill-item .api-icon,
	.skill-item .responsive-icon,
	.skill-item .ai-icon {
		width: 1.5rem;
		height: 1.5rem;
		flex-shrink: 0;
